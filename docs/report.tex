...
Section~II reviews related work; Section~III describes the simulator, planners, and agents; Section~IV presents the experimental protocol and results; and Section~V concludes with limitations and future work.
...
\begin{table}[ht]
  ...
  \begin{threeparttable}
    \begin{tabular}{lcccc}
      ...
      Base seed (graph/scenario gen.) & 42 & 42 & 42 & 42 \\
      \hline
...
\subsection{Experimental protocol, artifacts, and aggregation}
...
\subsection{Main results under Baseline demand}
...
\subsection{Bandit behavior and interpretability}
\label{sec:results_bandits}
...
\subsection{Validation note: inactive sweep dimensions}
